  ...
  <div className={classes.container}>
    ...
    <Slide right cascade>
      <div className={classes.row}>
        <p>
          ...
          <br />• React, Back4App, ParseAPI
          <br />
          <br />
          Hosted on Heroku. Made so that the owner could manage users and order
          statuses.
        </p>
      </div>
      <div className={classes.rowImages}>
        <img
          src="images/connecting1.png"
          alt=""
    ...
    <Slide left cascade>
      <div className={classes.row}>
        <p>
          Clock IO
          <br />• React, Redux, Go, PostgreSQL
          <br />
          <br />
          Time tracking application developed with a friend. Used to solve time
          management issues when working with personal or professional projects.{" "}
          <a href="https://clockio.online">Site</a>
        </p>
      </div>
      <div className={classes.rowImages}>
    ...
    <Slide right cascade>
      <div className={classes.row}>
        <p>
          Mercado Paso Fino
          <br />• React, NodeJS, MongoDB
          <br />
          <br />
          Market for farm owners and independent owners of "Paso Fino" horses to
    ...
    <Slide left cascade>
      <div className={classes.row}>
        <p>
          ...
          <br />
          <br />
          Graduation project for my Computer Science Bachelors. An inexpensive
